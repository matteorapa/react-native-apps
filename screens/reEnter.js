    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <TouchableOpacity style={{ position: 'absolute', zIndex: 1, top: 45, right: 85, width: 75, height: 40, borderRadius: 25, backgroundColor: 'grey', justifyContent: 'center', padding: 10 }}
                    onPress={() => this.reload()}
                >
